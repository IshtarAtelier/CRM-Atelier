...
| B2 | Cargar `GOOGLE_ADS_CONVERSION_LABEL` (hoy Google recibe 0 compras) | HTML vivo `"adsPurchaseLabel":"$undefined"`; `TrackingScripts.tsx:21-28`, `tracking.ts:244-256` | S | Puja/observación de compras. Queda SECUNDARIA — jamás optimizar a compra web |
...
| Compra web | Secundaria | Rota (B2+B3) | Observación, jamás puja |
