...
| lote-sep2026/*.json (×36) | PED-003510/12/16 | Clip-on (Cápsula Escarlata, categoría Lentes de Sol como sus hermanos) y sol: Eunice C3/C4, Bari, Módena, Lucca, Salerno, Zeus ×4, Meteoro ×4, Perseo ×2, Calisto ×2, Deméter, Eva ×2, Gema, Zafiro, Fénix C2, Tritón ×2, Sol, Odiseo, Plutón ×2, Luna, Edipo, Saturno, Urano, Kalishta, Perséfone. Redacción y color/forma verificados foto por foto (workflow 24/9/2026). 8 fichas usan el recorte del PDF del pedido porque el portal no lista ese tono (marcadas `_fotoDelPedido`). | ver cada spec |
