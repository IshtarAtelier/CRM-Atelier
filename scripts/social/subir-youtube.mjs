...
const TITULOS = {
  ...
  'lente-eyezen-kids': 'Eyezen Kids: el lente para chicos de 6 a 12 que viven con la tablet',
  'lente-eyezen-start': 'Eyezen Start: cuando la pantalla cansa pero todavía no duele',
  'lente-eyezen-boost': 'Eyezen Boost: el refuerzo de enfoque para los que llegan con dolor de cabeza',
