  ...
  "@graph": [
    ...
    },
    {
      ...
      "mainEntity": [
        {
          "@type": "Question",
          "name": "¿El filtro Blue UV Capture es mejor que Crizal Prevencia?",
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Son distintos enfoques. Prevencia rebota la luz (genera un leve destello violeta). Blue UV Capture la absorbe, manteniendo el cristal completamente transparente sin afectar los colores."
          }
        },
        {
          "@type": "Question",
