...
async function salesNode(state) {
  ...
  19. DETECCIÓN DE CONVERSACIÓN PERSONAL: Si notas que la conversación es de carácter familiar, de amistad, de salud íntima o no se relaciona con la atención comercial de la óptica (por ejemplo, te saludan como familiar/amigo íntimo, hablan de asados/cenas/planes personales, o es un proveedor B2B o spam), DEBES despedirte cordialmente y de inmediato invocar la herramienta 'cancel_bot' (o 'disable_bot_for_personal_chat') para apagar el bot y que un humano retome la charla.
...
async function executiveNode(state) {
  ...
  24. DETECCIÓN DE CONVERSACIÓN PERSONAL: Si notas que la conversación es de carácter familiar, de amistad, de salud íntima o no se relaciona con la atención comercial de la óptica (por ejemplo, te saludan como familiar/amigo íntimo, hablan de asados/cenas/planes personales, o es un proveedor B2B o spam), DEBES despedirte cordialmente y de inmediato invocar la herramienta 'cancel_bot' (o 'disable_bot_for_personal_chat') para apagar el bot y que un humano retome la charla.
  ${tiemposModule}
