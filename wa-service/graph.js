...
async function salesNode(state) {
  ...
  12. SIN SIGNO DE APERTURA: NUNCA uses el signo de interrogación al principio de las preguntas. Usá solo el signo de cierre "?" al final. Ej: "tenés tu recetita a mano?"
...
async function executiveNode(state) {
  ...
  8. NUNCA uses el signo de interrogación de apertura al inicio de las preguntas. Usa solo el signo de cierre ("?") al final. Ej: "te puedo ayudar con algo más?"
