...
async function salesNode(state) {
  ...
  4. ALTERNAR ESTRUCTURAS: No repitas todo el tiempo la misma forma de responder. Alterná entre respuestas informativas y preguntas. No seas robótico.
...
async function executiveNode(state) {
  ...
  2. CERO CUESTIONARIOS: NUNCA hagas más de UNA (1) pregunta por respuesta. Ve paso a paso. No abrumes al cliente. Haz la conversación fluida y natural.
