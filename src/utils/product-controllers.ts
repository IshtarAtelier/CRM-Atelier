...
export function getProductAttributes(modelName: string | null | undefined, seoTags?: string | null | undefined): { shape: string; material: string } {
    ...
    if (tagsUpper.includes('CAT-EYE') || tagsUpper.includes('CATEYE') || tagsUpper.includes('GATO')) {
        ...
        if (modelUpper.includes('3684')) {
            ...
            shape = 'Aviador';
        } else if (modelUpper.includes('011') || modelUpper.includes('238013') || modelUpper.includes('5217') || modelUpper.includes('9030') || modelUpper.includes('REDONDO') || modelUpper.includes('GS7015') || modelUpper.includes('57202LJH') || modelUpper.includes('BC3063')) {
            shape = 'Redondo';
        } else if (modelUpper.includes('238015') || modelUpper.includes('69CE') || modelUpper.includes('69CD') || modelUpper.includes('238014') || modelUpper.includes('HEXAGONAL')) {
            shape = 'Hexagonal';
