...
export function StorefrontFooterStatic() {
  ...
  const whatsappPhoneId = WHATSAPP_PHONE;
    ...
    <footer className="w-full relative z-10 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Manos trabajando una montura en el taller de Atelier"
          fill 
      ...
      <div className="relative z-10 w-full h-full bg-stone-950/90 backdrop-blur-3xl border-t border-white/10 text-stone-300">
        ...
        <div className="border-t border-white/10">
          <div className="mx-auto w-full max-w-6xl px-6 md:px-10 py-6 flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <span className="text-[11px] text-stone-300 font-medium">Envíos asegurados a todo el país</span>
            </div>
            <p className="text-[11px] text-stone-300">Comprobante AFIP Data Fiscal</p>
          </div>
        </div>
