  ...
  return (
    <div className="border border-[#e8e2db] rounded-2xl bg-white overflow-hidden transition-all duration-300 mb-4">
      <button
        ...
        className="w-full text-left px-6 py-5 flex items-center justify-between focus:ring-2 focus:ring-amber-500 focus:outline-none hover:bg-[#faf8f5] transition-colors"
      >
        <div>
