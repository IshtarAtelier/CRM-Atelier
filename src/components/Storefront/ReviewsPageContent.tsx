...
const FALLBACK_REVIEWS: Review[] = [
  ...
  {
    author_name: "Nicolás Bruno",
    profile_photo_url: "",
    rating: 5,
    relative_time_description: "Hace 2 meses",
    text: "Fui al local físico del Cerro de las Rosas y la experiencia boutique es única. Muy profesionales todos, se nota la diferencia en la calidad y la calidez humana.",
  },
  {
    author_name: "Sofía Domínguez",
    profile_photo_url: "",
    rating: 4,
    relative_time_description: "Hace 2 meses",
    text: "Me encantó el configurador online para armar los lentes. Hice el pedido con mi receta y todo salió muy bien. Muy recomendable la experiencia web.",
  },
  {
    author_name: "Ignacio Salcedo",
    profile_photo_url: "",
    rating: 5,
    relative_time_description: "Hace 3 meses",
    text: "La atención post-venta es impecable. Me reajustaron las patillas sin cargo y me dieron tips de cuidado. Un servicio boutique realmente premium.",
  }
];
