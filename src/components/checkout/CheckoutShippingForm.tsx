...
export function CheckoutShippingForm({ formData, handleChange, hasCrystals }: { formData: any, handleChange: any, hasCrystals: boolean }) {
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="-mt-0.5">
              <div className="flex items-center gap-2">
                <p className="text-sm font-bold text-black">Retiro en Tienda (Córdoba)</p>
