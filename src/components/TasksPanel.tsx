                            ...
                            {task.description.includes('Solicitar comentario') && task.client?.phone && (
                                <button
                                    onClick={(e) => {
                                        e.preventDefault();
                                        e.stopPropagation();
                                        const message = `Hola ${task.client.name.split(' ')[0]} Te molesto un segundito para que compartas tu experiencia de de compra en nuestro perfil de Google y sobre mi atencion:\n👉 https://g.page/r/CcVls8v7ic_NEBM/review\nNos suma muchisimo para seguir creciendo\nEspero tu comentario 🤍✨🫶`;
