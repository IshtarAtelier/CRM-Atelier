                        ...
                        <div className="flex items-center gap-3 mb-1">
                            ...
                            <div className="flex gap-0.5">
                                ...
                                {contact.status === 'CONFIRMED' && 
                                    (!contact.orders || !contact.orders.some((o: any) => (o.orderType === 'SALE' || o.orderType === 'MAYORISTA') && o.isDeleted !== true)) && (
                                    <button
                    ...
                    <div className="flex gap-1 bg-white dark:bg-stone-900 p-1.5 rounded-xl border border-stone-200 dark:border-stone-700 shadow-sm font-bold text-[10px] uppercase tracking-widest text-stone-400">
                        ...
                        {[1, 2, 3, 4, 5].map(star => (
                            <button
                                ...
                                className="transition-transform hover:scale-125 focus:ring-2 focus:ring-amber-500 focus:outline-none"
                            >
