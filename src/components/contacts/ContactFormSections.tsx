    ...
    return (
        <div className="p-6 bg-stone-50 dark:bg-stone-900/50 rounded-[2rem] border-2 border-stone-100 dark:border-stone-800">
            <div className="space-y-4">
                <label className="text-xs font-black uppercase tracking-widest text-stone-500 ml-1 flex items-center gap-1">Tipo de Producto <span className="text-primary">*</span></label>
