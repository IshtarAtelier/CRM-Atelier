                    ...
                    <div className="max-h-80 overflow-y-auto">
                        {visibleNotifications.length === 0 ? (
                            <div className="py-8 text-center">
                                ...
                                <p className="text-xs font-black text-stone-500 dark:text-stone-600 uppercase tracking-widest">Sin solicitudes</p>
                            </div>
                        ) : (
                                ...
                                <div key={n.id} className="px-4 py-3 border-b border-stone-50 dark:border-stone-800 hover:bg-stone-50 dark:hover:bg-stone-800/50 transition-colors">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-xs font-black text-stone-600 uppercase tracking-widest">{getTypeLabel(n.type)}</p>
                                            <p className="text-xs font-bold text-stone-700 dark:text-stone-500 mt-0.5 break-words whitespace-pre-wrap">{n.message}</p>
                                    ...
                                    <div className="flex gap-2 mt-2 ml-11">
                                        {n.orderId && (
                                            <a
                                                ...
                                                className="flex flex-1 items-center justify-center gap-1.5 px-3 py-2 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-blue-100 transition-all border border-blue-100 dark:border-blue-800"
