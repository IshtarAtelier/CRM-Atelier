                ...
                {orders.length > 0 ? (
                    orders.map(order => {
                        ...
                        return (
                            ...
                            >
                                <div className="absolute top-0 left-0 w-1.5 h-full bg-emerald-500/20 group-hover:bg-emerald-500 transition-colors" />

                                <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-950/30 rounded-2xl flex items-center justify-center text-emerald-600 group-hover:bg-emerald-500 group-hover:text-white transition-all shrink-0">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-baseline gap-2">
                                        <p className="text-lg font-black text-emerald-600 dark:text-emerald-400 tracking-tighter">
                                    ...
                                    <p className="text-[10px] font-bold text-stone-500 dark:text-stone-400 mt-1 uppercase tracking-wider">
                                        Pedido del {format(new Date(order.createdAt), "d 'de' MMM", { locale: es })}
                                    </p>
                                </div>
                                <ChevronRight className="w-5 h-5 text-stone-200 group-hover:text-emerald-500 transition-all group-hover:translate-x-1" />
                            </Link>
                        );
                    })
                ) : (
