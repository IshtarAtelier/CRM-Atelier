...
export const metadata: Metadata = {
  ...
  description: "Conocé a Matías Turchi, nuestro especialista en multifocales certificado como Essilor Expert. Precisión visual y última tecnología a tu disposición.",
  keywords: ["Matías Turchi", "Óptico", "Especialista Multifocales", "Essilor Expert", "Varilux", "Córdoba", "Atelier Óptica"],
  openGraph: {
    ...
    images: [
      {
        url: "https://atelieroptica.com/images/blog/matias-turchi.png",
        width: 800,
        height: 1067,
        alt: "Matías Turchi - Especialista en Multifocales",
      }
    ],
  },
  twitter: {
    ...
    title: "Matías Turchi | Especialista en Multifocales Essilor Expert",
    description: "Conocé a Matías Turchi, nuestro especialista en multifocales certificado como Essilor Expert. Precisión visual y última tecnología a tu disposición.",
    images: ["https://atelieroptica.com/images/blog/matias-turchi.png"],
  }
};
    ...
    <div className="bg-stone-50 min-h-screen text-black font-sans selection:bg-black selection:text-white">
      ...
      <div className="pt-24 pb-16 border-b border-stone-200 bg-white">
        <div className="max-w-[1000px] mx-auto px-5 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-light tracking-tight mb-6" style={{ fontFamily: "'Georgia', 'Times New Roman', serif" }}>
            Matías Turchi
          </h1>
      ...
      <main className="max-w-[1000px] mx-auto px-5 py-20 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-20">
          ...
          <div className="md:col-span-5">
            <div className="aspect-[3/4] relative overflow-hidden bg-stone-200 rounded-3xl sticky top-24 shadow-sm">
              ...
              <div className="absolute bottom-6 left-6 z-20 text-white">
                <p className="text-xs uppercase tracking-widest font-bold mb-1 drop-shadow-sm">Certificación</p>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-stone-900 mb-1">Essilor Expert</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-stone-900 mb-1">Precisión Extrema</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-stone-900 mb-1">Formación Continua</h4>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-stone-900 mb-1">Tecnología de Punta</h4>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="bg-white p-6 md:p-8 rounded-3xl shadow-sm border border-stone-100">
                  ...
                  <p className="text-[10px] font-bold text-stone-800 uppercase tracking-widest">— Reseña en Google Maps</p>
                </div>
