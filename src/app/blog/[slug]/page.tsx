      ...
      <>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-[#faf8f5] dark:bg-stone-850 p-6 rounded-3xl border border-black/5  flex flex-col justify-between hover:shadow-lg transition-all duration-300">
            <div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 bg-stone-100 relative shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-stone-150 dark:border-stone-750">
                <Image src={resolveStorageUrl("1780932146269_HY238014-c4-1.avif")} alt="Anteojo de diseño modelo Hera" width={1200} height={800} className="w-full h-full object-cover" />
              </div>
          ...
          <div className="bg-[#faf8f5] dark:bg-stone-850 p-6 rounded-3xl border border-black/5  flex flex-col justify-between hover:shadow-lg transition-all duration-300">
            <div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 bg-stone-100 relative shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-stone-150 dark:border-stone-750">
                <Image src={resolveStorageUrl("1780932170075_TL5217-c2.avif")} alt="Anteojo de diseño modelo Leda" width={1200} height={800} className="w-full h-full object-cover" />
              </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#faf8f5] dark:bg-stone-850 p-6 rounded-3xl border border-black/5  flex flex-col justify-between hover:shadow-lg transition-all duration-300">
            <div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 bg-stone-100 relative shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-stone-150 dark:border-stone-750">
                <Image src={resolveStorageUrl("1780932122264_GS7015-C3.avif")} alt="Anteojo de diseño modelo Iris" width={1200} height={800} className="w-full h-full object-cover" />
              </div>
          ...
          <div className="bg-[#faf8f5] dark:bg-stone-850 p-6 rounded-3xl border border-black/5  flex flex-col justify-between hover:shadow-lg transition-all duration-300">
            <div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 bg-stone-100 relative shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-stone-150 dark:border-stone-750">
                <Image src={resolveStorageUrl("1780932129076_HK011-c3.avif")} alt="Anteojo de diseño modelo Pandora" width={1200} height={800} className="w-full h-full object-cover" />
              </div>
        ...
        <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-[#faf8f5] dark:bg-stone-850 p-6 rounded-3xl border border-black/5  flex flex-col justify-between hover:shadow-lg transition-all duration-300">
            <div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 bg-stone-100 relative shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-stone-150 dark:border-stone-750">
                <Image src={resolveStorageUrl("1780932162871_TL3932-c3.avif")} alt="Anteojo de diseño modelo Diana" width={1200} height={800} className="w-full h-full object-cover" />
              </div>
          ...
          <div className="bg-[#faf8f5] dark:bg-stone-850 p-6 rounded-3xl border border-black/5  flex flex-col justify-between hover:shadow-lg transition-all duration-300">
            <div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 bg-stone-100 relative shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-stone-150 dark:border-stone-750">
                <Image src={resolveStorageUrl("1780932106867__91501-c6.avif")} alt="Anteojo de diseño modelo Athena" width={1200} height={800} className="w-full h-full object-cover" />
              </div>
          ...
          <div className="bg-[#faf8f5] dark:bg-stone-850 p-6 rounded-3xl border border-black/5  flex flex-col justify-between hover:shadow-lg transition-all duration-300">
            <div>
              <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-4 bg-stone-100 relative shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-stone-150 dark:border-stone-750">
                <Image src={resolveStorageUrl("1780932166781_TL3932-c4.avif")} alt="Anteojo de diseño modelo Ceres" width={1200} height={800} className="w-full h-full object-cover" />
              </div>
  ...
  'experiencia-boutique-atelier-optica': {
    ...
    content: (
      <>
        ...
        <div className="my-10 rounded-3xl overflow-hidden shadow-xl border border-black/5 ">
          <Image src="/images/blog/mostrador-marmol.webp" alt="Mostrador de mármol y estanterías iluminadas con anteojos" width={1200} height={800} className="w-full h-auto object-cover" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
          <div className="rounded-3xl overflow-hidden shadow-lg border border-black/5 ">
            <Image src="/images/blog/arte-monalisa.webp" alt="Cuadro de la Mona Lisa con lentes de sol y armazones Mistral" width={1200} height={800} className="w-full h-full object-cover" />
          </div>
          <div className="rounded-3xl overflow-hidden shadow-lg border border-black/5 ">
            <Image src="/images/blog/arte-venus.webp" alt="Cuadro del Nacimiento de Venus con lentes rojos y armazones Hanover" width={1200} height={800} className="w-full h-full object-cover" />
          </div>
        </div>
  ...
  'diseno-y-marcas-armazones-cordoba': {
    ...
    content: (
      <>
        ...
        <div className="my-10 rounded-3xl overflow-hidden shadow-xl border border-black/5 ">
          <Image src="/images/blog/anteojos-rosa-pastel.webp" alt="Detalle de armazones color rosa pastel sobre estantería de madera clara" width={1200} height={800} className="w-full h-auto object-cover" />
        </div>
        ...
        <div className="my-10 rounded-3xl overflow-hidden shadow-xl border border-black/5 ">
          <Image src="/images/blog/muestrario-smart-lens.webp" alt="Muestrario de cristales de colores Smart Lens sobre el mostrador de mármol" width={1200} height={800} className="w-full h-auto object-cover" />
        </div>
