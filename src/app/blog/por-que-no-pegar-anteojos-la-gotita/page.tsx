...
export const metadata: Metadata = {
  ...
  description: "Descubrí por qué pegar tus anteojos con cianoacrilato o La Gotita puede arruinarlos. Desde nuestro taller en Córdoba (cerca de Cerro de las Rosas y Nueva Córdoba) te contamos cómo solucionarlo. Envíos a toda Argentina y 6 cuotas sin interés.",
