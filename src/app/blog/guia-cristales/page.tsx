    ...
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white pb-20">
      ...
      <main className="max-w-3xl mx-auto px-6 pt-24 lg:pt-40">
        <div className="mb-12 lg:mb-16 text-center">
          ...
          <h1 className="text-3xl lg:text-5xl font-normal tracking-tight mb-6 lg:mb-8">Cómo elegir tus cristales</h1>
        ...
        <div className="space-y-12 lg:space-y-16">
          <section className="border-t border-[#e5e5e5] pt-12">
            <h2 className="text-xl font-medium mb-6 lg:mb-8 text-center">Tipos de Visión</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-8">
               <div className="border border-[#e5e5e5] p-6 lg:p-8">
               ...
               <div className="sm:col-span-2 border border-[#e5e5e5] p-6 lg:p-8">
          ...
          <section className="border-t border-[#e5e5e5] pt-12">
            <h2 className="text-xl font-medium mb-6 lg:mb-8 text-center">Tratamientos Premium</h2>
