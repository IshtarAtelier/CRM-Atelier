    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-white selection:text-black">
      ...
      <main>
        ...
        <section className="px-6 lg:px-16 pt-20 lg:pt-28 pb-20 lg:pb-28 max-w-3xl mx-auto">
          ...
          <div className="space-y-6 text-white/70 text-[15px] lg:text-base leading-relaxed">
            <p>
              <span className="text-white">Ishtar</span> es socia fundadora y está a cargo de la dirección artística de Atelier. Elige cada uno de los armazones que hay en la óptica, y cuando el local cierra sigue del otro lado de la pantalla. Amante de las nuevas tecnologías, el sistema con el que trabajamos lo escribió ella, igual que estas páginas, con la misma mirada con la que elige un armazón: para ella programar es otra forma de hacer arte. Es también la que habla con los proveedores, la que factura, y la que está cuando alguien del equipo necesita una mano.
            </p>
            <p>
