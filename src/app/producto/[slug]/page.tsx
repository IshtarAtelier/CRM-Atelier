  ...
  return (
    <div className="min-h-screen bg-white text-black selection:bg-black selection:text-white" style={{ fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif" }}>
      ...
      <div className="flex flex-col lg:flex-row min-h-screen pt-16 lg:pt-0">
        ...
        <div className="w-full lg:w-[45%] p-8 lg:p-16 flex flex-col bg-white">
          <div className="mb-12">
            ...
            <p className="text-[15px] text-[#999] mb-8">${MOCK_PRODUCT.price.toLocaleString()}</p>
      ...
      >
        ...
        <span className="text-[11px] font-bold uppercase tracking-widest hidden group-hover:inline-block pr-2">Asesor</span>
      </a>
    </div>
  );
}
