              ...
              {images.length > 0 ? (
                ...
                >
                  <Image 
                    ...
                    className={activeImageIndex === 0 ? (product.model?.toLowerCase().includes('tl3932 c3') || product.model?.toLowerCase().includes('diana') || product.id === 'cmq5d11hf002rhy61fhvqs7nj' ? "p-0 scale-[1.45]" : "p-8 lg:p-12") : ""}
                  />
                </motion.div>
              ) : (
