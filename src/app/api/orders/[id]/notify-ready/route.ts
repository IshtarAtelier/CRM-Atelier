...
<p>Te esperamos ${escHtml(BUSINESS_INFO.hours)}.</p>`,
        ...
        if (order.client.phone) {
            ...
            const template = financials.hasBalance
                ? templateSpec('pedido_listo_saldo_v4', [shortName, nro, fmt(financials.remainingCard), fmt(financials.remainingTransfer), fmt(financials.remainingCash)])
                : templateSpec('pedido_listo_v4', [shortName, nro]);
