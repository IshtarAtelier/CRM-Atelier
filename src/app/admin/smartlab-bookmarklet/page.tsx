...
export default function SmartLabBookmarkletPage() {
    ...
    // Use ref to bypass React's javascript: URL sanitization
    useEffect(() => {
        if (linkRef.current) {
            ...
            <div className="bg-white dark:bg-stone-800 rounded-3xl p-8 border-2 border-stone-200 dark:border-stone-700 shadow-xl">
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-lg font-black text-stone-800 dark:text-white">Copiá el código del robot</h2>
                    </div>
                    <div className="ml-11">
                        <button
                            onClick={handleCopy}
                            className={`px-8 py-4 rounded-2xl text-base font-black shadow-xl transition-all ${
                                copied
                                    ? 'bg-emerald-500 text-white shadow-emerald-400/30'
                                    : 'bg-gradient-to-r from-amber-400 to-orange-400 text-amber-950 shadow-amber-400/30 hover:scale-105'
                            }`}
                        >
                            {copied ? '✅ ¡Código copiado!' : '📋 Copiar código del robot'}
                        </button>
                    </div>
                </div>
                ...
                <div className="mb-8">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-lg font-black text-stone-800 dark:text-white">Creá el favorito en Chrome</h2>
                    </div>
                    <div className="ml-11 space-y-4">
                        <div className="bg-stone-50 dark:bg-stone-900 rounded-xl p-4 space-y-3">
                            <p className="text-sm text-stone-700 dark:text-stone-300">
                                <strong>Opción A (arrastrando):</strong> Arrastrá este botón a tu barra de favoritos:
                            </p>
                            <div className="text-center">
                                <a
                                    ...
                                    className="inline-block px-6 py-3 bg-gradient-to-r from-amber-400 to-orange-400 text-amber-950 rounded-xl text-sm font-black shadow-lg hover:scale-105 transition-all cursor-grab active:cursor-grabbing select-none"
                                >
                                    🤖 Atelier → SmartLab
                                </a>
                            </div>
                            ...
                            <p className="text-sm text-stone-700 dark:text-stone-300">
                                <strong>Opción B (manual, si arrastrar no funciona):</strong>
                            </p>
                            <ol className="text-sm text-stone-600 dark:text-stone-400 space-y-2 list-decimal list-inside">
                                <li>Tocá <strong>📋 Copiar código del robot</strong> (arriba)</li>
                                <li>Hacé click derecho en la barra de favoritos → <strong>&quot;Agregar página...&quot;</strong></li>
                                <li>En <strong>Nombre</strong> poné: <code className="bg-stone-200 dark:bg-stone-700 px-1 rounded text-xs">🤖 Atelier SmartLab</code></li>
                                <li>En <strong>URL</strong>: borrá todo lo que haya y <strong>pegá</strong> (Cmd+V)</li>
                ...
                <div className="bg-red-50 dark:bg-red-950/20 border-2 border-red-200 dark:border-red-800 rounded-2xl p-4 mt-6">
                    ...
                    <p className="text-sm text-red-700 dark:text-red-300">
                        El robot <strong>NUNCA</strong> hace clic en &quot;Guardar pedido&quot;. Solo llena los campos.
