            ...
            if (clientPhone) {
                ...
                if (formattedPhone) {
                    ...
                    const template = financials.hasBalance
                        ? templateSpec('pedido_listo_saldo_v4', [clientName, nro, fmt(financials.remainingCard), fmt(financials.remainingTransfer), fmt(financials.remainingCash)])
                        : templateSpec('pedido_listo_v4', [clientName, nro]);
